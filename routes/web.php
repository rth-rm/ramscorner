...
use App\Http\Controllers\Notificationller;
...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::get('/openTicketByNotif/{nid}', [NotificationController::class, 'openTicketByNotif'])->name('openTicketByNotif');
    Route::get('/clientOpenTicketByNotif/{nid}', [NotificationController::class, 'clientOpenTicketByNotif'])->name('clientOpenTicketByNotif');
