...
<!-- <link rel="stylesheet" href="clicked_tik.css"> -->
            ...
            <div class="dash-contents">
                <div class="dash-container">
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body"
                            style="padding: 5px;   display: grid; grid-template-columns: 1fr 1fr 1fr 1fr;">

                            <!-- ticket status -->
                            <div class="ticket-status me-2" style="">
                                <h4 style="color: #817e9d; font-size: 21px; font-weight: 700;"
                                    class="pt-4 ps-4 pb-3 fw-bold">Status Tracking</h4>
                            ...
                            <div class="ticket-details" style="grid-column: span 3;">
                                ...
                                <div class="tic-attachment ps-5">
                                    <h5>
                                        @if ($tickets->t_image != '')
                                            Attachment:
                                            <h6><a href="{{ url('ticketImages/' . $tickets->t_image) }}"
                                                    download>{{ $tickets->t_image }}</a>
                                                <h6>
                                                @else
                                        @endif
                                    </h5>
                        ...
                        <div class="card-footer text-body-secondary p-4"
                            ...
                            <div class="dropdown">
                                <button class="btn dropdown-toggle btn-lg me-3" type="button" data-bs-toggle="dropdown"
                                    aria-expanded="false"
                                    style="background: #6644A8; color: white; border-radius: 25px;">
                                    Update
                                </button>
                                <ul class="dropdown-menu">
