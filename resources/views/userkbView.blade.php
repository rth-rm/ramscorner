...
<link rel="stylesheet" href="{{ asset('assets/css/client-kb-clicked.css') }}" type="text/css">
</head>
...
<body>
    ...
    <div class="" style=" border-radius: 4px; border: 1px solid #ffffff7c; position: absolute; background-color: rgb(255, 255, 255); top: 10%; left: 7%; height: 89%; width: 92%; padding: 3%;">
            ...
            <div class="card">
                <div class="card-header" style="background-color:rgb(0, 21, 126); color:white">
                    <h2 class="text-group-title"><i class="bi bi-list-check" style="font-size:40px"></i>
                        Support ID#</strong>{{ $kb_info->kb_ID }}:
                        {{ $kb_info->kb_title }} </h5>
