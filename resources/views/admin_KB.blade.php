...
<body>
                        ...
                        <div class="card-body p-0">
                            <div class="lists">
                                ...
                                <div class="card-footer text-body-secondary" style="display: flex; justify-content: end; background-color: #fff">
                                    <a href="{{ url('add_kb') }}">
                                        <button type="button" class="btn btn-primary btn-lg" style="border-radius: 25px; background-color:#6644a8;">Create KB
                                            Article</button>
                                    </a>
                                </div>
                            </div>
    ...
    <div class="col notification m-2" id="showDiv2" style="background-color: #ffc74e; position: relative;display: inline-block; padding: 1%; color: #000000; font-size: 18px; border-radius: 4px; cursor: pointer;">
    ...
    <form id="search-form">
        <input id="search-input" type="search" name="searchKB" placeholder="Search Knowledge Base" style=" flex: 1; padding: 12px 20px;  margin: 8px 0; box-sizing: border-box;  border: 2px solid #ccc;  border-radius: 4px; width: 70%;">
        <button type="submit" value="Search" style=" width: auto;  padding: 10px 18px;  background-color: #4CAF50; color: white; margin: 8px 0; border: none;  border-radius: 4px; cursor: pointer;"><i class="bi bi-search"></i> Search</button>
    </form>
    ...
    <ul class="nav nav-pills m-3 fs-4" id="pills-tab" role="tablist" style="justify-content: center; ">
        <li class="nav-item" role="presentation">
            <button onclick="showElement('All')" class="nav-link active" id="" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">All</button>
        </li>
        <li class="nav-item" role="presentation">
            <button onclick="showElement('Infrastructure')" class="nav-link" id="Infrastructure" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Infrastructure</button>
        </li>
        <li class="nav-item" role="presentation">
            <button onclick="showElement('Software')" class="nav-link" id="Software" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">Software</button>
        </li>
    </ul>
    </div>
    ...
    <div id="kbs" class="overflow-auto border border-secondary-subtle shadow" style="position: relative; height: 75%;display:block" name="unapp">
        <div>
                ...
                <a href="adminkbView/{{ $kb_info->kb_ID }}" class="card content {{ $kb_info->kb_category }}" id="content clickable" style="margin: 1%; cursor: pointer; text-decoration:  none; color: black;">
                    ...
                    <div class="card-body">
                        <blockquote class="blockquote mb-0">
                            ...
                            <footer class="blockquote-footer">KBID #{{ $kb_info->kb_ID }}<cite title="Source Title"></cite></footer>
    ...
    <div id="kbs" class="overflow-auto border border-secondary-subtle shadow" style="position: relative; height: 75%;display:none" name="app">
        <div>
    ...
    <div style="position: fixed; top: 14%;right:6%; bottom: 5%;">
        ...
        <button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#createModal" data-bs-whatever="" style="width: 130%"><i class="bi bi-plus-circle-fill"></i> Create KB</button>
    </div>
    ...
    <!-- create KB -->
    <form method="post" encytpe="multipart/form-data" action="{{ url('/createKB') }}" class="row g-3 needs-validation" novalidate>
        @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-text">
                                <input class="form-check-input mt-0" type="checkbox" value="1" name="userview" aria-label="Checkbox for following text input">
                            </div>
                            <input placeholder="Available for client view?" class="form-control" aria-label="Text input with checkbox" readonly="true">
                        </div>
